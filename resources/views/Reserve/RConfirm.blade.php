<x-app-layout>
    <x-slot name="header">
    <x-article-title caption="{{ __('Confirm Shop Entry') }}" />
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-4 p-4">
            ...
            <x-rtextbox name="ConfirmCode" required>確認コードを入力してください:</x-rtextbox>
            <a href="{{route('reserve.fixed',$reserve)}}">
                <x-primary-button>
                    予約確定
                </x-primary-button>
            </a>
